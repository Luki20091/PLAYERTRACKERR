...
public enum ConfigOption {
    ...
    COMPASS_MAX_DURABILITY("compass.max-durability", Type.INTEGER, 10),
    ...
    COMPASS_STACKABLE("compass.stackable", Type.BOOLEAN, false),
    COMPASS_ENCHANT_ENABLED("compass.enchant.enabled", Type.BOOLEAN, true),
    ...
    DEBUG("debug", Type.BOOLEAN, false),
